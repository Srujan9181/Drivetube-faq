...
// Suggested code may be subject to a license. Learn more: ~LicenseLog:4129293622.
  ...
  return (
    ...
    <main className='faqs'>
      <div className='question' id="q1" onClick={handlearrow}>What is an Admin Dashbord? <span id='normal'>{arrow}</span></div>
      ...
      <div className='question' id="q2" onClick={handlearrow}>What should an admin dashboard template include? <span  id='normal' >{arrow}</span></div>
      <div className='answer'id='a2'>ans2</div>
      <div className='question' id="q3" onClick={handlearrow}>Why should i buy admin templates from AdminMart? <span id='normal' >{arrow}</span></div>
      <div className='answer' id='a3'>ans3</div>
      <div className='question' id="q4" onClick={handlearrow}>Do Adminmart offers a money back gurantee <span id='normal'>{arrow}</span></div>
